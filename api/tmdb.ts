...
export const getDiscoverMoviesInfiniteQuery = getInfiniteQuery<DiscoverMovieResponse, DiscoverMovieInput>(GetDiscoverMoviesQueryKey);
...
export const getMovieRecommendationsQuery = getQuery<MovieRecommendationsResponse, MovieRecommendationInput>(GetMovieRecommendationsQueryKey);
export const getMovieRecommendationsLazyQuery = getLazyQuery<MovieRecommendationsResponse, MovieRecommendationInput>(GetMovieRecommendationsQueryKey);
export const getMovieRecommendationsInfiniteQuery = getInfiniteQuery<MovieRecommendationsResponse, MovieRecommendationInput>(GetMovieRecommendationsQueryKey);
...
export const getTVRecommendationsLazyQuery = getLazyQuery<TVRecommendationsResponse, TVRecommendationInput>(GetTVRecommendationsQueryKey);
export const getTVRecommendationsInfiniteQuery = getInfiniteQuery<TVRecommendationsResponse, TVRecommendationInput>(GetTVRecommendationsQueryKey);
