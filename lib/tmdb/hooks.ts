import { InfiniteData, QueryClient, UseInfiniteQueryOptions, UseMutationOptions, UseQueryOptions } from "@tanstack/react-query";
import { AxiosError } from "axios";
import { uniqBy } from "ramda";
import { tmdbDeleteFn, tmdbGetFn, tmdbPatchFn, tmdbPostFn, tmdbPutFn } from "./client";
...
export interface GetLazyQueryOptions<TResponse, TVariables, TError = unknown> extends UseMutationOptions<
  TResponse,
  AxiosError<TError>,
  TVariables
> {
...
export interface MutationQueryOptions<TResponse, TVariables, TError = unknown> extends UseMutationOptions<
  TResponse,
  AxiosError<TError>,
  TVariables
> {
